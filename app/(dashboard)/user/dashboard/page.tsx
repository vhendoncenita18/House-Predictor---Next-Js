...
import SampleCards from "@/components/user-dashboard/sampleCards";
import MyPredictions from "@/components/user-dashboard/myPredections";
import OtherPredictions from "@/components/user-dashboard/otherPredictions";
